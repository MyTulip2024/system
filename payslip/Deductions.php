    ...
    <script>
        ...
        function downloadHistory() {
            ...
            if (employeeDepartment !== 'N/A') {
                doc.text('Department: ' + employeeDepartment, 14, currentY);
                currentY += 7;
            }
            ...
            const tableData = filteredData.map(item => {
                const formattedGross = 'P' + item.gross_pay.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                const formattedDeductions = 'P' + item.deductions.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                const formattedNet = 'P' + item.net_pay.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
            ...
            const formattedTotalGross = 'P' + totalGross.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
            const formattedTotalDeductions = 'P' + totalDeductions.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
            const formattedTotalNet = 'P' + totalNet.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
