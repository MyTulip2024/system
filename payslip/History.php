...
<body>
    ...
    <script>
        ...
        function convertPeso(amount) {
            return 'P' + numberFormat(amount);
        }
        ...
        function downloadHistory() {
            ...
            const tableData = filteredData.map(item => {
                ...
                const formattedGross = 'P' + formatNumber(item.gross_pay);
                const formattedDeductions = 'P' + formatNumber(item.deductions);
                const formattedNet = 'P' + formatNumber(item.net_pay);
            ...
            const formattedTotalGross = 'P' + formatNumberForPDF(totalGross);
            const formattedTotalDeductions = 'P' + formatNumberForPDF(totalDeductions);
            const formattedTotalNet = 'P' + formatNumberForPDF(totalNet);
            ...
            const filename = 'Salary_History_<?php echo htmlspecialchars($employee_no); ?>_' + dateStamp + '.pdf';
